...
interface SummaryInputProps {
  ...
  domain: DocumentDomain;
  onDomainChange: (domain: DocumentDomain) => void;
}
...
export function SummaryInput({ onSummarize, isProcessing, domain, onDomainChange }: SummaryInputProps) {
  ...
  return (
    <div className="flex flex-col h-full gap-4">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar space-y-4 pr-1">
        ...
        {showAdvanced && (
          <div className="space-y-5 animate-in fade-in slide-in-from-top-2 duration-300 mt-4">
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <select value={domain} onChange={e => onDomainChange(e.target.value as DocumentDomain)}
